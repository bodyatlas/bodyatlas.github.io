...
:root{--bg:#f6f4ef;--surface:#fff;--surface-2:#f1eee7;--surface-3:#e8e4da;--text:#1b1f27;--muted:#5d6470;--border:#d9d4c8;--border-strong:#b9b2a2;--ink:#1b2a41;--accent:#0f766e;--accent-hover:#0b5f59;--accent-soft:#d8efe9;--accent-text:#fff;--danger:#b42318;--ok:#15803d;--ok-soft:#dcf5e3;--warn:#b45309;--warn-soft:#fef1dd;--focus:#2563eb;--radius:10px;--radius-sm:6px;--font:ui-sans-serif,system-ui,-apple-system,"Segoe UI",Roboto,Arial,sans-serif;--mono:ui-monospace,Menlo,Consolas,monospace}
